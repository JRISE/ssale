		  ...
		  <tr>
			<td height="31">
			  <div class="titlebt">
			    ...
			    <a href="${pageContext.request.contextPath}/menuAction_createUI?pageNum=<s:property value="#page.pageNum" />" class="title_bt2"><img class="title_bt3" src="${pageContext.request.contextPath}/images/user/22.gif" width="14" height="14" />新增角色</a>
		      ...
		      <tr>
		        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" >
		          <tr>
		            ...
		            <td width="5%" height="28" background="${pageContext.request.contextPath}/images/frame/news-title-bg28.gif"><div align="center"><span class="STYLE1">菜单ID</span></div></td>
		            <td width="8%" height="28" background="${pageContext.request.contextPath}/images/frame/news-title-bg28.gif"><div align="center"><span class="STYLE1">菜单名称</span></div></td>
		            <td width="20%" height="28" background="${pageContext.request.contextPath}/images/frame/news-title-bg28.gif"><div align="center"><span class="STYLE1">菜单说明</span></div></td>
		            <td width="8%" height="28" background="${pageContext.request.contextPath}/images/frame/news-title-bg28.gif"><div align="center"><span class="STYLE1">URL</span></div></td>
		            <td width="8%" height="28" background="${pageContext.request.contextPath}/images/frame/news-title-bg28.gif"><div align="center"><span class="STYLE1">父菜单</span></div></td>
		            <td width="10%" height="28" background="${pageContext.request.contextPath}/images/frame/news-title-bg28.gif"><div align="center"><span class="STYLE1">基本操作</span></div></td>
		          </tr>
		          ...
		          <tr bgcolor='<s:property value="#s.odd?'#FFFFFF':'#eaf0f4'"/>'>
		            ...
		            <td height="20" align="center"><span class="STYLE1"><s:property value="id" /></span></td>
		            ...
		            <td height="20" align="center"><span class="STYLE1"><s:property value="url"/></span></td>
		            <td height="20" align="center"><span class="STYLE1"><s:property value="parentMenu.name"/></span></td>
		            <s:hidden name="id"></s:hidden>
		            <td height="30" align="center">
		            	<s:a class="title_bt4" href="menuAction_updateUI?id=%{id}&pageNum=%{#page.pageNum}" ><img class="title_bt5" src="${pageContext.request.contextPath}/images/user/edt.gif" width="16" height="16" />
		            		编辑&nbsp; &nbsp;</s:a>
		            	<s:a class="title_bt4" href="menuAction_delete?id=%{id}&pageNum=%{#page.pageNum}" onclick="javascript:return p_del()"><img class="title_bt5" src="${pageContext.request.contextPath}/images/user/del.gif" width="16" height="16" />
		            		删除</s:a>
		            </td>
		          </tr>
		          </s:iterator>
		            ...
		            <td><table border="0" align="right" cellpadding="0" cellspacing="0">
		                <tr>
		                  <td width="40"><s:if test="#page.pageNum==1"><a class="title_bt4" href="#" >首页</a></s:if>
		                  	<s:elseif test="#page.pageNum!=1"><a class="title_bt4" href="${pageContext.request.contextPath}/menuAction_toList?pageNum=1" >首页</a></s:elseif></td>
	               		  <td width="40"><s:if test="#page.pageNum==1"><a class="title_bt4" href="#" >上一页</a></s:if>
	               		  	<s:elseif test="#page.pageNum!=1"><a class="title_bt4" href="${pageContext.request.contextPath}/menuAction_toList?pageNum=<s:property value="#page.pageNum-1" />" >上一页</a></s:elseif></td>
		                  <td width="40"><s:if test="#page.pageNum==#page.totalPage"><a class="title_bt4" href="#" >&nbsp;下一页</a></s:if>
		                  	<s:elseif test="#page.pageNum!=#page.totalPage"><a class="title_bt4" href="${pageContext.request.contextPath}/menuAction_toList?pageNum=<s:property value="#page.pageNum+1" />" >&nbsp;下一页</a></s:elseif></td>
		                  <td width="30"><s:if test="#page.pageNum==#page.totalPage"><a class="title_bt4" href="#" >&nbsp;尾页</a></s:if>
		                  	<s:elseif test="#page.pageNum!=#page.totalPage"><a class="title_bt4" href="${pageContext.request.contextPath}/menuAction_toList?pageNum=<s:property value="#page.totalPage" />" >&nbsp;尾页</a></s:elseif></td>
		                <form action="menuAction_toList" method="get">
	...
	$("#delete").click(function(){
		...
		if(flag == 0){
			...
			if(confirm("您真的要删除选择的员工吗？\n\n请确认！")){
				...
				window.location.href = "menuAction_deleteBatch?num="+$("#num1").val()+"&ids="+ids;
			}
		}
	});
});
